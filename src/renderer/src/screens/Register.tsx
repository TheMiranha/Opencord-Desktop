      ...
      <div className="flex-1 flex items-center justify-center p-4">
        <div className="w-[480px] rounded-md bg-discord-bg p-8 shadow-2xl no-drag select-text">
          ...
          <form onSubmit={handleRegister} className="flex flex-col gap-4">
            ...
            <button 
              type="submit" 
              className="mt-4 w-full rounded bg-discord-blurple py-3 font-semibold text-white transition-colors hover:bg-discord-blurpleHover cursor-pointer"
            >
              Registrar
            </button>
          </form>
          ...
          <div className="mt-4 text-[14px]">
            ...
            <button onClick={() => navigate('/login')} className="font-medium text-discord-link hover:underline cursor-pointer">
              Faça Login
            </button>
          </div>
